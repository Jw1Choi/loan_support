 ...
 <div class="form-box" id="fm-box" style="padding-top:50px;">
  ...
  <h2>1분 신청으로 간편하게<br>승인 가능 최대 한도 조회하기</h2><br>
        ...
        <div class="form-box-inner">
            ...
            <input type="hidden" name="entry.31896802" value="메타 광고" >
                ...
                <br>
                    ...
                    <tr id="select_lic">
                      <th><!--<i class="fa fa-user" aria-hidden="true"></i>-->신용카드 유무<br></th>
                      <td>
                  ...
                  <tr id="select_lic">
                    <th><!--<i class="fa fa-user" aria-hidden="true"></i>-->대출 종류<br></th>
                    <td>
                        ...
                        <select name='entry.490720003' id='loan' class="form-control" placeholder="대출 종류">
                            ...
                            <option value="대출 종류" selected disabled>대출 종류</option>
                                <option value="긴급자금대출">긴급자금대출</option>
                                <option value="저금리전환대출(대환대출)">저금리전환대출(대환대출)</option>
                                <option value="생활자금대출">생활자금대출</option>
                                <option value="운영자금대출">운영자금대출</option>
                ...
                <tr id="select_lic">
                  ...
                  <td>
                      ...
                      <select name='entry.1412376890' id='type' class="form-control" placeholder="소득 유형">

                          <option value="소득 유형" selected disabled>소득 유형</option>
                              <option value="4대보험가입자">4대보험가입자 (직장인)</option>
                              <option value="4대보험 미가입자">4대보험 미가입자 (프리랜서, 알바)</option>
                              <option value="사업자/자영업자">사업자/자영업자</option>
