...
function maxLengthCheck(object){
 ...
 function hoa(){ 
        ...
        $(window).scrollTop(0);
        window.location.href = './result-hsl.html';
 }
...
$(function(){
 $('#name,#phone,#loan,#age,#message,#agree11,#now-wg,#hope-wg,#height,#db,#type,#warningCheck,#card').bind("keyup click change",form_check);
 $('#name,#phone,#loan,#age,#message,#agree11,#now-wg,#hope-wg,#height,#db,#type,#warningCheck,#card').bind("keyup click change",form_check1);
